...
const MessagesPanel = (props) => {
  ...
  useEffect(() => {
    ...
    scrollToBottom();
    processNewMessage();
    console.log("Selected User is", props.selectedRoomId);
  });
  ...
  return (
    <div className={messageStyle}>
      <div className="message-panel-chat-header">
        <div className="media d-flex align-items-center">
          {/* )} */}
          <div className="media-img-wrap">
            <div className="avatar">
              <img
                src="../../images/user_123.jpg"
                alt="User"
          ...
          <div className="media-body">
            <div className="user-name">Minhas</div>
      ...
      <div className="show-messages">
        {showLoading == true ? (
          ...
          messagePanelData.messages.map((message) => {
            return (
              <Message key={message.id} {...message} userInfo={userInfo} />
            );
          })
        )}
